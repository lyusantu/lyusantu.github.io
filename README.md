...
4. Copy
   [`index.html`](https://github.com/lyusantu/lyusantu.github.io/blob/master/index.html),
   [`about.md`](https://github.com/lyusantu/lyusantu.github.io/blob/master/about.md),
   [`archives.md`](https://github.com/lyusantu/lyusantu.github.io/blob/master/archives.md),
   [`feed.xml`](https://github.com/lyusantu/lyusantu.github.io/blob/master/feed.xml), and
   [`_data/navigation.yml`](https://github.com/lyusantu/lyusantu.github.io/blob/master/_data/navigation.yml)
   from the theme:

   ``` sh
   rm index.md
   curl -L -O "https://github.com/lyusantu/lyusantu.github.io/raw/master/{index.html,about.md,archives.md,feed.xml}"
   curl -L --create-dirs -o _data/navigation.yml https://github.com/lyusantu/lyusantu.github.io/raw/master/_data/navigation.yml
   ```
